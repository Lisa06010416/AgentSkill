---
name: code-review
description: Perform a structured code review on diffs, files, or selected code. Use when Claude is asked to review code changes, audit a pull request, check for bugs or security issues, or give feedback on code quality.
---
